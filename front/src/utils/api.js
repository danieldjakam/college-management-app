    ...
    try {
      ...
      if (attempt > 0) {
        ...
        const isRateLimitError =
          lastError instanceof NetworkError && lastError.status === 429;
...
export const apiEndpoints = {
  ...
  getOrderedStudents: (classId) =>
    api.get(`/students/getOrdonnedStudents/${classId}`),
  ...
  configureClassPayments: (id, data) =>
    api.post(`/school-classes/${id}/configure-payments`, data),
