        ...
        <nav className="navbar navbar-expand-lg" style={{padding: '10px'}}>
            <div className="collapse navbar-collapse" id="navbarNav">
                <ul className="navbar-nav" style={{fontSize: '1.3rem', display:"flex", justifyContent:'space-between'}}>
                    ...
                    <a target={'_blank'} href={`${host}/download/note/${ActualClass.id}/${type}`} style={{marginLeft: '10px'}} className="btn btn-primary">Fichier d'import</a>
                    ...
                    onChange={(e) => {handleChangeCsvFile(e, `/upload/note/${actualExam.id}/${ActualClass.id}/${type}`, setError)}} />
                </ul>
            </div>
        </nav>
