        ...
        <form onSubmit={(e) => {handleUpdate(e)}}>
            ...
            <table className='table table-bordered'>
                ...
                <tbody>
                    <tr>
                        <td>
                            <input type='text' value={classs.first_date} onChange={(e) => {setClasss(val => {return {...val, first_date: e.target.value}})}} className='form-control' style={{ width: '70px' }} />
                        </td>
                        <td>
                            <input type="text" value={classs.last_date} onChange={(e) => {setClasss(val => {return {...val, last_date: e.target.value}})}} className='form-control' style={{ width: '70px' }} />
                        </td>
                    </tr>
                </tbody>
            </table>
