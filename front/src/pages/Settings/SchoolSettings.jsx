        ...
        try {
            ...
            if (response.success) {
                ...
                if (response.data.school_logo) {
                    try {
                        const logoResponse = await secureApiEndpoints.schoolSettings.getLogo();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (logoFile) {
                ...
                // Débogage temporaire
                console.log('Sending FormData with logo:', logoFile.name, logoFile.size, logoFile.type);
                for (let [key, value] of formData.entries()) {
                    console.log('FormData entry:', key, typeof value === 'object' ? value.name : value);
                }
            } else {
        ...
        <Container fluid className="py-4">
            ...
            <Row className="mb-4">
                <Col>
                    ...
                    <p className="text-muted">Configurez les informations générales de votre établissement</p>
                </Col>
            </Row>
                                    ...
                                    <Col md={6}>
                                        <Form.Group className="mb-3">
                                            ...
                                            <Form.Control
                                                ...
                                                onChange={(e) => handleInputChange('scholarship_deadline', e.target.value)}
                                            />
                                            <Form.Text className="text-muted">
                                                Les étudiants doivent payer avant cette date pour bénéficier des bourses et réductions
                                            </Form.Text>
                                        </Form.Group>
                                    </Col>
                                    <Col md={6}>
                                        <Form.Group className="mb-3">
                                            ...
                                            <Form.Control
                                                ...
                                                onChange={(e) => handleInputChange('reduction_percentage', parseFloat(e.target.value) || 0)}
                                            />
                                            <Form.Text className="text-muted">
                                                Réduction appliquée aux anciens élèves et aux nouveaux payant avant délai
                                            </Form.Text>
                                        </Form.Group>
                                    </Col>
                                </Row>
                        ...
                        <Card className="mb-4">
                            ...
                            <Card.Body>
                                ...
                                <small className="text-muted">
                                    Cette couleur sera appliquée aux boutons, liens et éléments principaux de l'interface.
                                </small>
                            </Card.Body>
                        </Card>
                    </Col>
