...
const EditStudent = ({error, setError, studentToEditId, setIsEditStudent}) => {
  ...
  <form onSubmit={(e) => {handleUpdate(e)}}>
    <div className="card-content">
      {
        sessionStorage.stat === 'ad' || sessionStorage.stat === 'comp' ?
            <>
                <div className="field">
      ...
      <div className="field">
          ...
          <input type="text" className='form-control' value={student.birthday} onChange={(e) => {setStudent(val => {return {...val, birthday: e.target.value}})}} placeholder={studentTraductions[getLang()].birthday} />
      </div>
      <div className="field">
        ...
        sessionStorage.stat === 'ad' || sessionStorage.stat === 'comp' ?
            ...
            <div className="field check " style={{display:'flex'}}>
                ...
                <div className="field" style={{display:'flex'}}>
                    <label className={`label ${student.isNew === 'yes' ? 'checked' : ''}`} htmlFor='isNew'>Apres compo ? </label>
                    <select value={student.isNew} onChange={(e) => {setStudent(val => {return{...val, isNew: e.target.value}})}} id="isNew">
