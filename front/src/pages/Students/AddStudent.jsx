        ...
        <form onSubmit={(e) => {handleAdd(e)}}>
          <div className="card-content">
            ...
            <div className="field">
                ...
                <input type="text" className='form-control' value={data.birthday} onChange={(e) => {setData(val => {return {...val, birthday: e.target.value}})}} placeholder={studentTraductions[getLang()].birthday} />
            </div>
            <div className="field">
            ...
            <div className="field check " style={{display:'flex'}}>
                ...
                <input type="checkbox" checked={data.status === 'new' ? true : false} 
                  onChange={(e) => {setData(val => {return{...val, status: data.status === 'new' ? 'old' : 'new'}})}} id="check" />
            </div> 
            <div className="field" style={{display:'flex'}}>
                <label className={`label ${data.isNew === 'yes' ? 'checked' : ''}`} htmlFor='isNew'>Apres compo ? </label>
                <select value={data.isNew} onChange={(e) => {setData(val => {return{...val, isNew: e.target.value}})}} id="isNew">
