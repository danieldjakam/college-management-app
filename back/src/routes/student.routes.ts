...
routerForStudent.get('/gs', authGlobalForStudent, authForStudent, studentController.gAFC);
...
routerForStudent.put('/transfert-to', authGlobalForStudent, authForStudent, studentController.transfertToAotherClass)
