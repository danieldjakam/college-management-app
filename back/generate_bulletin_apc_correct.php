...
/**
 * 🎓 GÉNÉRATION BULLETIN APC 1ER CYCLE - VERSION CORRIGÉE
...
echo "🚀 Génération du bulletin APC 1er cycle (version corrigée)...\n";

// 1. CHARGER LE TEMPLATE
$templatePath = __DIR__ . '/resources/views/bulletins/bulletin_apc_1er_cycle_correct.html';
...
$data = [
    ...
    'stat_cna' => '4',
    'success_rate' => '94,4',
    'appreciation_text' => 'Bon travail. Compétences bien acquises en Mathématiques, Informatique et EPS.',
    'detailed_appreciation' => 'Points forts: Excellente maîtrise des matières scientifiques. Bonnes capacités de raisonnement logique. Participation active en classe. Points à améliorer: Renforcer l\'orthographe et l\'expression écrite. Travailler la régularité dans les matières littéraires.',
];
...
try {
    ...
    $pdfFile = __DIR__ . '/bulletin_apc_correct_6eme.pdf';
