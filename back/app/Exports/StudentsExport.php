...
class StudentsExport implements FromCollection, WithHeadings, WithMapping, WithStyles, ShouldAutoSize
{
    ...
    {
        $query = Student::with([
            'classSeries.schoolClass.section', 
        ...
        if (!empty($this->filters['section_id'])) {
            $query->whereHas('classSeries.schoolClass', function($q) {
    ...
    public function map($student): array
    {
        return [
            ...
            $student->address ?? 'N/A',
            $student->classSeries->name ?? 'N/A',
            $student->classSeries->schoolClass->name ?? 'N/A',
            $student->classSeries->schoolClass->section->name ?? 'N/A',
            $student->classSeries->schoolClass->level->name ?? 'N/A',
