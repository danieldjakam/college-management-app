...
<head>
    ...
    <style>
        * {
        ...
        /* Colonne 2 (droite) */
        .card-wrapper:nth-child(2) { top: 0mm; left: 104.4mm; }
        .card-wrapper:nth-child(4) { top: 62mm; left: 104.4mm; }
        .card-wrapper:nth-child(6) { top: 124mm; left: 104.4mm; }
        .card-wrapper:nth-child(8) { top: 186mm; left: 104.4mm; }
        .card-wrapper:nth-child(10) { top: 248mm; left: 104.4mm; }
    ...
    @for ($page = 0; $page < $totalPages; $page++)
        ...
        <div class="cards-grid">
            @for ($cardIndex = $page * $cardsPerPage; $cardIndex < min(($page + 1) * $cardsPerPage, $totalCards); $cardIndex++)
                ...
                <div class="card">
                    <!-- Image de fond en base64 (chargée une seule fois) -->
                    <div class="card-background">
                        @if($templateBase64)
                        <img src="data:image/png;base64,{{ $templateBase64 }}" alt="Template">
                        @endif
                    </div>

                    <div class="card-overlay">
                        <!-- Photo élève en base64 (déjà redimensionnée) -->
