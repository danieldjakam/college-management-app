...
<head>
    ...
    <title>Rapport Mensuel - Présences Personnel Permanent</title>
    <style>
        @page {
            size: A3 landscape;
            margin: 5mm;
...
<body>
    <div class="header">
        ...
        <div class="subtitle">Rapport Mensuel de Présences - Personnel Permanent</div>
    </div>
    ...
    <div class="info-bar">
        ...
        <span>
            <span class="info-label">Total Personnel:</span>
            <span class="info-value">{{ count($staff) }}</span>
        </span>
        <span>
    ...
    <table class="calendar-table">
        <thead>
            <tr>
                ...
                <th class="stats-header" style="background-color: #dc3545;">Total<br>Retard</th>
            </tr>
        </thead>
        <tbody>
            @foreach($staff as $employee)
                <tr>
                    ...
                    @foreach($employee['days'] as $dayData)
                        @php
                    ...
                    <td class="stats-cell">
                        <span class="total-hours">{{ $employee['total_hours'] }}</span>
                    </td>
                    <td class="stats-cell">{{ $employee['working_days'] }}</td>
                    <td class="stats-cell">{{ $employee['present_days'] }}</td>
                    <td class="stats-cell">{{ $employee['absent_days'] }}</td>
                    <td class="stats-cell">{{ $employee['late_days'] }}</td>
                    <td class="stats-cell">{{ $employee['half_days'] }}</td>
                    <td class="stats-cell" style="color: #dc3545; font-weight: bold;">{{ $employee['total_late_formatted'] ?? '00:00' }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
    ...
    <div class="legend">
        ...
        <span class="legend-item" style="color: #dc3545;"><strong>Total Retard</strong> : Cumul retard mensuel (HH:MM)</span>
    </div>
